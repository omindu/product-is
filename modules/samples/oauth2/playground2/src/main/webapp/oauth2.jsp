...
<head>
    ...
    <script type="text/javascript">
        ...
        function getDecodedHeader() {
            var idToken = getIDtoken();
            if (idToken) {
                var decodedHeader = atob(idToken.split(".")[0]);
        ...
        <td>
                    ...
                    <table class="user_pass_table">
                        ...
                        <%
                            if (idToken != null) {
                                ...
                                String headerString = signedJWT.getHeader().toString();
                                String payloadString = signedJWT.getPayload().toString();
                        %>
                        <tr>
                        ...
                        <tr>
                            <script type="text/javascript">
                                makeList(<%=headerString%>);
                            </script>
                        </tr>
                        <tr>
                            <td><label style="font-weight: bold;">Payload</label></td>
                        <tr>
                        <tr>
                            <script type="text/javascript">
                                makeList(<%=payloadString%>);
                            </script>
                        </tr>
                        <%
                            }
            ...
            <div>
                <table class="user_pass_table">
                    ...
                    <tr>
                        <script type="text/javascript">
                            var decodedPayload = JSON.parse(getDecodedHeader());
                            makeList(decodedPayload);
                        </script>
                    </tr>
                    <tr>
                        <td><label style="font-weight: bold;">Payload</label></td>
                    ...
                    <tr>
                        <script type="text/javascript">
                            var decodedPayload = JSON.parse(getDecodedIDToken());
                            makeList(decodedPayload);
                        </script>
                    </tr>
                    </tbody>
