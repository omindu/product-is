...
import org.wso2.is.portal.user.client.api.SelfSignUpClientService;
...
/**
 * OSGi tests for SelfSignUpClientService.
 */
@Listeners(PaxExam.class)
@ExamReactorStrategy(PerSuite.class)
public class SelfSignUpClientServiceTest {
    ...
    @Inject
    private SelfSignUpClientService selfSignUpClientService;
